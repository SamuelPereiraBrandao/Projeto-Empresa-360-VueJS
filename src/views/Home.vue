                        ...
                        <nav class="navbar navbar-expand-lg navbar-light ">
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarCollapse">
                                    <a @click="meuMenuToggle()"><div class="navbar-nav">
                                    
                                        <router-link exact-active-class="ativo"
                                            class="list-group-item list-group-item-action" to="/home/dashboard"><i
                                        ...
                                        <router-link exact-active-class="ativo"
                                            class="list-group-item list-group-item-action" to="/home/vendas/leads"><i
                                                class="bi bi-caret-right"></i> Leads</router-link>
                                        <router-link exact-active-class="ativo"
                                            class="list-group-item list-group-item-action" to="/home/vendas/contratos">
                                            <i class="bi bi-caret-right"></i> Contratos</router-link>
                                        <router-link exact-active-class="ativo"
                                            class="list-group-item list-group-item-action" to="/home/servicos"><i
        ...
        <div class="d-flex">
            <div>
                <div class="list-group menu-esquerda oculto">
                    <i @click="meuMenuToggle()"><router-link exact-active-class="ativo" class="list-group-item list-group-item-action"
                    ...
                    <router-link exact-active-class="ativo" class="list-group-item list-group-item-action"
                        to="/home/servicos"><i class="bi bi-card-checklist"></i> Serviços</router-link></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3 mb-lg-0">
                    <div class="hover hover-2 text-white rounded"><img
                            src="https://p2.trrsf.com/image/fget/cf/940/0/images.terra.com/2016/01/28/riomaggiore.jpg" alt="">
                        <div class="hover-overlay"></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3 mb-lg-0">
                    <div class="hover hover-5 text-white rounded"><img
                            src="https://www.smartia.com.br/blog/wp-content/uploads/2019/03/funciona-seguro-vida.jpg" alt="">
                        <div class="hover-overlay"></div>
                        <div class="hover-5-content">
                            <h3 class="hover-5-title text-uppercase font-weight-light mb-0">SEGURO <strong
                                    class="font-weight-bold text-white"> </strong><span> VIDA</span></h3>
